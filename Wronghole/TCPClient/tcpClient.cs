...
namespace Examples.System.Net
{
    public class SslTcpClient
    {
        ...
        static X509CertificateCollection clientCertificate { get; set; }
        public string Ip { get; set; }
        public int Port { get; set; }
        public SslTcpClient(string ip, string port, string cert)
        {
            Ip = ip;
            clientCertificate.Add(X509Certificate.CreateFromCertFile(cert));
